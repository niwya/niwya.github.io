...
import { ArticleCard } from 'gatsby-theme-portfolio-minimal/src/components/ArticleCard';
...
export default function ArticleListingTemplate(props: ArticleListingTemplateProps): React.ReactElement {
    ...
    return (
        <>
            <Seo title="All Projects" useTitleTemplate={true} />
            <Page>
                <Section anchor="articleListing" heading="Projects">
